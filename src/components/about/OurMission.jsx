    ...
    <div className="px-10 pt-20 bg-black">
      <div className="flex flex-row">
        <div className="flex flex-col">
          ...
          <h2 className="text-white text-5xl font-semibold pt-5 tracking-wider">
        ...
        <div className="flex flex-col ml-10">
          <img src={img1} className="rounded-2xl h-[450px] w-[380px]" alt="" />
        ...
        <div className="">
          <img
            className="h-[350px] w-[250px] rounded-2xl mt-80 ml-28 mb-20"
            src={img3}
            alt=""
          />
        </div>
