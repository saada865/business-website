  ...
  return (
    <div className=" bg-[#F5F5F5] p-10 ">
      <div className=" bg-black p-5 rounded-2xl">
        <div className="block lg:flex flex-row justify-between pt-10 pl-10">
          <div className="flex flex-col pr-10">
            <p className="text-md text-white mb-5">
              Pleasure and so read the was hope.
            </p>
            <h2 className="text-white text-3xl xl:text-7xl tracking-wide">
              Ready to take <br />
              <span className=" text-green-300 "> your business </span> <br />
              to the next <br />
              level?
            </h2>
            <p className="text-white text-sm lg:text-lg font-semibold mt-5 lg:mt-10">
            ...
            <div className="flex flex-row items-center text-center">
              <img
                src={img2}
                className="rounded-full h-12 w-12 lg:h-20 lg:w-20 mt-10"
                alt=""
              />
          ...
          <div className="">
            <img
              className=" h-[300px] w-[600px] lg:h-[700px] lg:w-[1500px]"
              src={img}
              alt=""
            />
          </div>
